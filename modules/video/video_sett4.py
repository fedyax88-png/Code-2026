# modules/video_sett4.py
from PyQt6.QtWidgets import QFrame, QVBoxLayout, QHBoxLayout, QLabel, QPushButton
from PyQt6.QtCore import Qt
from PyQt6.QtGui import QPixmap
import styles

class VideoSettingBlock4(QFrame):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setObjectName("SettingCard")
        self.setStyleSheet("QFrame#SettingCard { background-color: #03060f; border: 1px solid #101f38; border-radius: 10px; }")
        ...
        self.toggle.setStyleSheet("background-color: #00d2ff; border: none; border-radius: 10px; text-align: right; padding-right: 0px; color: white; font-size: 34px; font-weight: bold; padding-top: -10px;")
